...
const modelMap = {
  ...
  prescriptions: 'NH_Prescription',
  radiology: 'NH_RadiologyOrder',
  surgeries: 'NH_Surgery',
  medicines: 'NH_Medicine',
  returns: 'NH_ReturnRequest',
  ward_indents: 'NH_MedicineIndent',
  nursing_charges: 'NH_NursingCharge',
  nurse_handovers: 'NH_Handover',
  pac_requests: 'NH_PACRequest',
  fluid_io: 'NH_FluidIO',
  birth_records: 'NH_BirthRecord',
  death_records: 'NH_DeathRecord',
  referrals: 'NH_ReferralCommission',
  referrers: 'NH_Referrer',
  estimates: 'NH_Estimate',
  employees: 'NH_Employee',
  payroll: 'NH_PayrollRun',
  leave_requests: 'NH_LeaveRequest',
  attendance: 'NH_Attendance',
  expenses: 'NH_Expense',
  service_catalog: 'NH_ServiceCatalog',
  service_orders: 'NH_ServiceOrder',
  billing_ledger: 'NH_BillingLedger',
};
