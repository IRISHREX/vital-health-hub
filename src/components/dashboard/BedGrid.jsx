          ...
          <div key={floor} className="border rounded-lg overflow-hidden">
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <Badge variant="secondary" className="ml-2 bg-blue-500 text-white border-0 hover:bg-blue-600 hover:text-white">
                      ...
                      <div key={roomKey} className="border rounded-lg overflow-hidden bg-gray-50">
                        ...
                        >
                          <div className="flex items-center gap-2">
                            ...
                            <Badge variant="outline" className="ml-2 bg-status-available/80 text-white border-0 hover:bg-status-available hover:text-white">
